                    ...
                    <div className="navbar-end text-[#ffffffa6]">
                        {user ? (
                                    ...
                                    <div className="absolute right-0 mt-7 bg-[#F4F5FE] shadow-md rounded-lg  z-50 border w-[250px] p-4">
                                        <div className="w-500px">
                                            <ul className="menu menu-horizontal px-1  text-[#111] flex flex-col ">
                                                <li className="hover:bg-[#e4e6f8]"><NavLink className={({ isActive }) => (isActive ? 'bg-red-500' : '')} to='/add-car'>Add Car</NavLink></li>
                                                <li className="hover:bg-[#e4e6f8]"><NavLink className={({ isActive }) => (isActive ? 'bg-red-500' : '')} to='/my-cars'>My Cars</NavLink></li>
                                                <li className="hover:bg-[#e4e6f8]"> <NavLink className={({ isActive }) => (isActive ? 'bg-red-500' : '')} to='/my-booking'>Add Car</NavLink></li>
                                            </ul>
                            ...
                            <div className="flex gap-4">
                                <Link to="/register" className=" bg-red-500 rounded-none px-6 py-2 text-white">
                                    Register
                                </Link>
